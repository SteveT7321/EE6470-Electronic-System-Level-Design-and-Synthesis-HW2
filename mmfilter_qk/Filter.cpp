...
// //////////////////////////only send the info from initialtor to the target(single thread)
// ////////////////////////// but the adder has no thread
// ////////////////////////// could add wait() here, because the do_sobel means nothing to the initiator
